...
import { areaData, selectedAreaForecast, officesList, selectedAreaName, selectedAreaInfo } from "../stores/weatherStore";
import { selectConstellation, CONSTELLATION } from "../stores/fortuneStore";

const loadError = ref("");
const areaSaveBtn = ref(null);
...
function changeCenters() {
  // console.log('選択されたセンター:', selectCenters.value, selectCenters.value.code, selectCenters.value.name);
}
...
function changeOffices() {
  // console.log('選択されたオフィス:', selectOffices.value, selectOffices.value.code, selectOffices.value.name);
}
...
function changeClass10() {
  // console.log('選択されたクラス10:', selectClass10.value, selectClass10.value.code, selectClass10.value.name);
}
...
function changeClass15() {
  // console.log('選択されたクラス15:', selectClass15.value, selectClass15.value.code, selectClass15.value.name);
}
...
function changeClass20() {
  // console.log('選択されたクラス20:', selectClass20.value, selectClass20.value.code, selectClass20.value.name);
}
...
function areaSave() {
  ...
  if (result) {
    // selectedAreaInfo.value = selectedAreaName.value;
